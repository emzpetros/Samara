...
namespace AssetInventory
{
    public sealed class MaintenanceUI : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            EditorGUILayout.Space();
            _validatorSearch = SearchField.OnGUI(_validatorSearch, GUILayout.ExpandWidth(true));
            ...
            {
                if (validator.CurrentState == Validator.State.Completed && validator.IssueCount > 0 && validator.Fixable) _fixeableItems++;
                if (!MatchesValidatorSearch(validator.Name, _validatorSearch)) continue;
                ...
                switch (validator.CurrentState)
                {
                    ...
                    case Validator.State.Completed:
                        ...
                        if (validator.IssueCount > 0 && !validator.Fixable) resultText += " (not automatically fixable)";
